...
import gov.nasa.worldwind.util.TemporalityRenderableAdapter;
...
public class TemporalityExample
{
    ...
    private static class AppFrame extends javax.swing.JFrame
    {
        ...
        public AppFrame()
        {
            ...
            TemporalityRenderableAdapter tadapter1 = new TemporalityRenderableAdapter(img, tempor);
            ...
            tempor = new Temporality(cal_ini, cal_fin);
            TemporalityRenderableAdapter tadapter2 = new TemporalityRenderableAdapter(circle, tempor);
            ...
            tempor = new Temporality(cal_ini, cal_fin);
            TemporalityRenderableAdapter tadapter3 = new TemporalityRenderableAdapter(img, tempor);
