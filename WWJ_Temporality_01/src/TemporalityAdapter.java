...
/**
 * TemporalityAdapter joins a Renderable object with a Temporality. Then
 ...
 */
public class TemporalityAdapter implements Renderable
{

    private Temporality temporality = null;
    private Renderable renderable = null;

    public TemporalityAdapter(Renderable renderable, Temporality temporality)
    {
