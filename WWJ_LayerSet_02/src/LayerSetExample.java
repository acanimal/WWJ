...
public class LayerSetExample
{
    ...
    private static class AppFrame extends javax.swing.JFrame
    {
        ...
        public AppFrame()
        {
            ...
            ScalebarLayer scl = new ScalebarLayer();
            groupC.add(scl);
            ...
            System.out.println("Contains GroupC: "+main.contains(groupC));
            System.out.println("Contains ScaleBar: "+main.contains(scl));
            System.out.println("Contains model: "+main.contains(model));
            
            System.out.println("Contains Class BMNGSurfaceLayer: "+main.containsClass(BMNGSurfaceLayer.class));
            System.out.println("Contains Class TrackLayer: "+main.containsClass(TrackLayer.class));
            
            System.out.println("Index of BMNG respect main layer: "+main.indexOf(BMNGSurfaceLayer.class));
            System.out.println("Index of BMNG respect GroupB layer: "+groupB.indexOf(BMNGSurfaceLayer.class));
        }
    }
